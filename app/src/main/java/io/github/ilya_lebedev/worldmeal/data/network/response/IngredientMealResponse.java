...
public class IngredientMealResponse {
    ...
    @NonNull
    private final IngredientMealEntry[] mIngredientMeal;

    public IngredientMealResponse(@NonNull final IngredientMealEntry[] ingredientMeal) {
        mIngredientMeal = ingredientMeal;
    }

    public IngredientMealEntry[] getIngredientMeal() {
