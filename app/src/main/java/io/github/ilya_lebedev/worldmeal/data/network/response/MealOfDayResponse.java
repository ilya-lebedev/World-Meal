...
public class MealOfDayResponse {

    @NonNull
    private final MealOfDayEntry mMealOfDay;

    public MealOfDayResponse(@NonNull final MealOfDayEntry mealOfDay) {
        mMealOfDay = mealOfDay;
    }
