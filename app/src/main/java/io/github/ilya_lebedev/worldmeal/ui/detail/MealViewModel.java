...
public class MealViewModel extends ViewModel {
    ...
    private final LiveData<MealEntry> mMeal;

    public MealViewModel(WorldMealRepository repository, long mealId) {
        mRepository = repository;
        mMealId = mealId;
        mMeal = mRepository.getMeal(mMealId);
    }

    public LiveData<MealEntry> getMeal() {
        return mMeal;
    }
